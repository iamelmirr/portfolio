...
const footerLinks = [
  {
    title: 'GitHub',
    href: 'https://github.com/iamelmirr'
  },
  {
    title: 'X',
    href: 'https://x.com/beskeiks'
  },
  {
    title: 'Instagram',
    href: 'https://instagram.com/besirovicelmir'
  },
  {
    title: 'LinkedIn',
      ...
      <div className="border-t border-white/15 py-6 text-sm flex flex-col md:flex-row md:justify-between items-center gap-8">
        ...
        <nav className="flex flex-col md:flex-row items-center gap-8">
          {footerLinks.map(link => (
            <a href={link.href} key={link.title} target="_blank" className="inline-flex items-center gap-1.5 z-20 hover:opacity-85 transition">

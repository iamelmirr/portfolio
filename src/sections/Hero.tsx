      ...
      <div id='hero' className="py-32 md:py-48 lg:py-60 lg:pt-48 relative z-0 overflow-x-clip">
        ...
        <div className='max-w-lg mx-auto'>  
          ...
          <p className='mt-4 text-center text-white md:text-lg'>
            I have experience working with various technologies, including web and mobile development, backend services, and blockchain. Let&apos;s discuss your next project.
          </p>
          </div>
